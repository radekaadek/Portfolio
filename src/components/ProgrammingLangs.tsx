...
const ProgrammingLangs = () => {
    return (
        <div className='border border-blue-600 rounded-lg p-2 my-4' style={{width: "min(20rem, 100vw)", backgroundColor: "#001e3c"}}>
            ...
            <div className="flex justify-center p-5">
                <ul className="list-disc list-inside p-3">
                    {programmingLanguages.map((language) => (
                        <span key={language.id} className='flex text-xl' style={{color: "#f3f6f9"}}>
